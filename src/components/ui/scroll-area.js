...
var ScrollArea = React.forwardRef(function (_a, ref) {
    ...
    return (<ScrollAreaPrimitive.Root ref={ref} className={(0, utils_js_1.cn)('relative overflow-hidden', className)} {...props}>
...
var ScrollBar = React.forwardRef(function (_a, ref) {
    ...
    return (<ScrollAreaPrimitive.ScrollAreaScrollbar ref={ref} orientation={orientation} className={(0, utils_js_1.cn)('flex touch-none select-none transition-colors', orientation === 'vertical' &&
