...
var Separator = React.forwardRef(function (_a, ref) {
    ...
    return (<SeparatorPrimitive.Root ref={ref} decorative={decorative} orientation={orientation} className={(0, utils_js_1.cn)('shrink-0 bg-border', orientation === 'horizontal' ? 'h-[1px] w-full' : 'h-full w-[1px]', className)} {...props}/>);
});
